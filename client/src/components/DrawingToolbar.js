    ...
    <Draggable handle=".drawing-toolbar-handle">
      <div
        className={`drawing-toolbar ${
          !isExpanded ? 'drawing-toolbar--collapsed' : ''
        }`}
      >
        <div
        ...
        >
          ...
          {username && (
            <span className="drawing-toolbar-user">
              <span
                className="drawing-toolbar-user-color"
          ...
          <div className="drawing-toolbar-content">
                ...
                {tools.map((tool) => (
                  <button
                    ...
                    className={`drawing-toolbar-btn ${
                      currentTool === tool.id ? 'drawing-toolbar-btn--active' : ''
                    }`}
                    onClick={() => onToolChange(tool.id)}
                    title={tool.name}
                  >
            ...
            <div className="drawing-toolbar-section">
              ...
              <div className="drawing-toolbar-colors">
                ...
                <input
                  type="color"
                  className="drawing-toolbar-color-btn drawing-toolbar-color-picker"
                  value={currentColor}
